...
```
cd existing_repo
git remote add origin https://gitlab.com/anvacon-team/feacna-batch.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/anvacon-team/feacna-batch/-/settings/integrations)
