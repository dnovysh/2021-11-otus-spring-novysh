...
@DataJpaTest
@Import({GenreStorageServiceImpl.class})
class GenreStorageServiceImplTest {
    ...
    void shouldReturnEntireGenreHierarchyStartWithId() {
        ...
        var emptyList = new ArrayList<GenreClassifierProjection>();
        var expectedGenre = new GenreClassifierProjection("57.20", "Computer Science", genre57,
                List.of(
                        new GenreClassifierProjection("57.20.03", "Algorithms", genre5720, emptyList),
                        new GenreClassifierProjection("57.20.16", "Coding", genre5720, emptyList),
                        new GenreClassifierProjection("57.20.21", "Computers", genre5720,
                                List.of(
                                        new GenreClassifierProjection("57.20.21.37", "Hackers",
                                                genre572021, emptyList),
                                        new GenreClassifierProjection("57.20.21.40", "Internet",
                                                genre572021, emptyList)
                                )),
                        new GenreClassifierProjection("57.20.53", "Programming", genre5720, emptyList),
                        new GenreClassifierProjection("57.20.54", "Programming Languages", genre5720, emptyList),
                        new GenreClassifierProjection("57.20.61", "Software", genre5720, emptyList),
                        new GenreClassifierProjection("57.20.63", "Technical", genre5720, emptyList)
                ));
    ...
    void shouldReturnEntireGenreHierarchyStartWithRoot() {
        ...
        var expectedGenres = List.of(
                new GenreClassifierProjection("08", "Artificial Intelligence", null, emptyList),
                new GenreClassifierProjection("57", "Science", null,
                        List.of(
                                new GenreClassifierProjection("57.20", "Computer Science", genre57,
                                        List.of(
                                                new GenreClassifierProjection("57.20.03", "Algorithms", genre5720, emptyList),
                                                new GenreClassifierProjection("57.20.16", "Coding", genre5720, emptyList),
                                                new GenreClassifierProjection("57.20.21", "Computers", genre5720,
                                ...
                                new GenreClassifierProjection("57.64", "Technology", genre57, emptyList)
                        ))
        );
    ...
    void shouldReturnPathById() {
        var genre57 = new GenreParentsProjection("57", "Science", null, null);
        var genre5720 = new GenreParentsProjection("57.20", "Computer Science", genre57, null);
        var genre572021 = new GenreParentsProjection("57.20.21", "Computers", genre5720, null);
